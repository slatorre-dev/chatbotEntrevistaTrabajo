...
const odsInfo = {
  ...
  7:  { label: 'Energía asequible',           color: '#FCC30B' },
  ...
  16: { label: 'Paz y justicia',              color: '#00689D' },
...
const students = [
  {
    ...
    cycle: 'CFGS Marketing y Publicidad · CFGS Administración y Finanzas',
    ...
    about: 'Alumna con doble titulación: CFGS Marketing y Publicidad y CFGS Administración y Finanzas. Una combinación poco habitual y muy demandada: entiende tanto la rentabilidad de una campaña como su impacto de marca. Busco FP Dual en empresa donde la estrategia comercial y el rigor financiero trabajen juntos.',
    skills: [
      { name: 'Estrategia de marca',    level: 'avanzado' },
      { name: 'Marketing digital / SEO',level: 'avanzado' },
      { name: 'Contabilidad analítica', level: 'avanzado' },
      { name: 'Google Analytics / Ads', level: 'avanzado' },
      { name: 'Excel / Power BI',       level: 'medio' },
      { name: 'ERP Holded / SAGE',      level: 'medio' },
    ],
    projects: [
      { icon: '📊', title: 'ROI de campaña con Power BI', desc: 'Dashboard de rentabilidad de campañas publicitarias: coste por adquisición, margen y ROAS. Presentado a dirección de empresa local', tags: ['Power BI', 'Marketing', 'ROI', 'Finanzas'] },
      { icon: '📣', title: 'Campaña "FP Sin Límites"',    desc: 'Campaña de comunicación para visibilizar la FP. Vídeo viral con +12.000 visualizaciones. Presupuesto de 0€ gestionado con rigor contable', tags: ['Redes sociales', 'Storytelling', 'Presupuesto', 'ODS 4'] },
    ],
    verifiedBy: { name: 'Prof. I. Castillo', skills: 7 },
    ods: [5, 8, 10],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    cycle: 'CFGS Automatización y Robótica Industrial',
    school: 'IES Juan Bosco · Alcázar de San Juan',
    available: true,
    availableDate: 'Sep 2025',
    location: 'Alcázar de San Juan, Castilla-La Mancha',
    ...
    skills: [
      ...
      { name: 'Neumática industrial',level: 'avanzado' },
      { name: 'SCADA / WinCC',      level: 'medio' },
      { name: 'SolidWorks 3D',      level: 'medio' },
      { name: 'Python / ROS',       level: 'basico' },
    ],
    projects: [
      { icon: '🤖', title: 'Célula robótica clasificadora', desc: 'Brazo UR3e + cinta transportadora: visión artificial OpenCV + PLC CODESYS para clasificación de piezas por color y forma', tags: ['UR3e', 'OpenCV', 'CODESYS', 'Robótica'] },
      { icon: '🌡️', title: 'Control PID de temperatura',   desc: 'Sistema PID con PLC Siemens S7-1200 para horno eléctrico industrial. Supervisión en tiempo real con SCADA WinCC', tags: ['PLC', 'PID', 'SCADA', 'Siemens'] },
    ],
    verifiedBy: { name: 'Prof. S. Domínguez', skills: 6 },
    ods: [9, 13, 4],
  },
  {
    ...
    avatarColor: '#2dcc7a',
    name: 'Ahmed Benali',
    cycle: 'CFGM Integración Social',
    school: 'IES Juan Bosco · Alcázar de San Juan',
    available: false,
    availableDate: 'Sep 2025',
    location: 'Alcázar de San Juan, Castilla-La Mancha',
    about: 'Alumno de 1º CFGM Integración Social. Su experiencia migratoria y el dominio de árabe, francés y español le dan una perspectiva única para la mediación intercultural y el trabajo comunitario. Comprometido con la inclusión y la igualdad de oportunidades para todas las personas.',
    skills: [
      { name: 'Mediación intercultural', level: 'avanzado' },
      { name: 'Árabe / Francés / Esp.',  level: 'avanzado' },
      { name: 'Dinámica de grupos',      level: 'medio' },
      { name: 'Animación sociocultural', level: 'medio' },
      { name: 'Intervención comunitaria',level: 'medio' },
      { name: 'Técnicas de orientación', level: 'basico' },
    ],
    projects: [
      { icon: '🌍', title: 'Talleres mediación escolar', desc: 'Diseño e impartición de talleres de mediación intercultural en 3 aulas del IES para la convivencia y resolución de conflictos', tags: ['Mediación', 'Diversidad', 'Convivencia'] },
      { icon: '📖', title: 'Guía de recursos bilingüe',  desc: 'Guía bilingüe árabe-español de recursos sociales del municipio para personas recién llegadas a la comarca', tags: ['Traducción', 'Inclusión', 'Recursos'] },
    ],
  ...
  },
  {
    ...
    projects: [
      ...
      { icon: '🏥', title: 'Taller RCP en el aula', desc: 'Taller práctico de reanimación cardiopulmonar básica impartido a compañeros y compañeras de ciclo', tags: ['RCP', 'Primeros auxilios', 'Formación'] },
    ],
  ...
  },
  {
    ...
    initials: 'EF',
    avatarColor: '#e879f9',
    name: 'Elena Fuentes Ramos',
    cycle: 'CFGS Desarrollo de Aplicaciones Multiplataforma',
    school: 'IES Juan Bosco · Alcázar de San Juan',
    available: true,
    availableDate: 'Mar 2026',
    location: 'Alcázar de San Juan, Castilla-La Mancha',
    github: 'elena-fuentes-dev',
    about: 'Alumna de 2º CFGS DAM. Desarrolladora backend apasionada por la arquitectura de software y las APIs REST. Contribuidora activa en proyectos open source y mentora informal de otras alumnas que se inician en la programación.',
    skills: [
      { name: 'Java / Spring Boot',  level: 'avanzado' },
      { name: 'Kotlin / Android',    level: 'avanzado' },
      { name: 'APIs REST / OpenAPI', level: 'avanzado' },
      { name: 'SQL / PostgreSQL',    level: 'medio' },
      { name: 'Docker / CI-CD',      level: 'medio' },
      { name: 'Git / GitHub Actions',level: 'avanzado' },
    ],
    projects: [
      { icon: '📱', title: 'App gestión deportiva', desc: 'App Android nativa (Kotlin + MVVM) para ligas locales: clasificaciones, resultados y notificaciones push Firebase', tags: ['Kotlin', 'Android', 'Firebase', 'MVVM'] },
      { icon: '⚙️', title: 'API REST biblioteca',   desc: 'Backend Spring Boot con JWT, documentación Swagger y despliegue en Railway. Más de 800 peticiones/día en producción', tags: ['Java', 'Spring Boot', 'JWT', 'Docker'] },
    ],
    verifiedBy: { name: 'Prof. J. García', skills: 7 },
    ods: [9, 4, 5],
  },
  {
    ...
    projects: [
      { icon: '🏃', title: 'Programa actividad física 3ª edad', desc: 'Diseño y coordinación de programa de ejercicio adaptado para 25 residentes mayores con seguimiento semanal de movilidad', tags: ['Geriatría', 'Fisioterapia', 'Prevención'] },
      { icon: '📋', title: 'Protocolo prevención UPP',          desc: 'Protocolo de prevención de úlceras por presión adaptado a residencia de 80 plazas usando escala Braden', tags: ['Protocolos', 'Cuidados', 'Enfermería'] },
    ],
    verifiedBy: { name: 'Prof. A. Morales', skills: 5 },
    ods: [3, 5, 10],
  },
  {
    id: 8,
    initials: 'FA',
    avatarColor: '#10b981',
    name: 'Fátima Al-Rashid',
    cycle: 'CFGM Instalaciones Eléctricas y Automáticas',
    school: 'IES Juan Bosco · Alcázar de San Juan',
    available: true,
    availableDate: 'Sep 2025',
    location: 'Alcázar de San Juan, Castilla-La Mancha',
    ...
    skills: [
      ...
      { name: 'Domótica KNX',        level: 'avanzado' },
      { name: 'PLC Schneider',       level: 'medio' },
      { name: 'AutoCAD Eléctrico',   level: 'medio' },
      { name: 'Energías renovables', level: 'basico' },
    ],
    projects: [
      { icon: '🏠', title: 'Vivienda domotizada KNX', desc: 'Proyecto completo domótica KNX para vivienda unifamiliar: iluminación, persianas, climatización y seguridad integrada', tags: ['KNX', 'Domótica', 'BT', 'AutoCAD'] },
      { icon: '☀️', title: 'Instalación FV 5 kWp',    desc: 'Dimensionado e instalación de sistema fotovoltaico de autoconsumo 5 kWp para nave industrial local con monitorización', tags: ['Solar', 'Fotovoltaica', 'BT', 'Renovables'] },
    ],
    verifiedBy: { name: 'Prof. T. Ruiz', skills: 6 },
    ods: [9, 7, 13],
  },
  {
    id: 9,
    ...
    skills: [
      ...
      { name: 'ERP SAP / Holded',       level: 'avanzado' },
      { name: 'Nóminas / IRPF',         level: 'medio' },
      { name: 'Inglés B2',              level: 'medio' },
      { name: 'Python finanzas',         level: 'basico' },
    ],
    projects: [
      { icon: '📈', title: 'Dashboard financiero Power BI', desc: 'Panel KPIs financieros (EBITDA, margen, rotación) para empresa agroalimentaria local con datos en tiempo real vía API', tags: ['Power BI', 'DAX', 'Análisis', 'KPIs'] },
      { icon: '🏦', title: 'Plan de viabilidad empresa',    desc: 'Estudio completo (ingresos, gastos, VAN, TIR) para apertura de comercio local. Defendido ante panel evaluador del centro', tags: ['Finanzas', 'VAN', 'TIR', 'Excel'] },
    ],
    verifiedBy: { name: 'Prof. M. Ortega', skills: 6 },
    ods: [8, 10, 5],
  },
  {
    id: 10,
    initials: 'VC',
    avatarColor: '#ef4444',
    name: 'Valentina Cruz Molina',
    cycle: 'CFGM Sistemas Microinformáticos y Redes',
    school: 'IES Juan Bosco · Alcázar de San Juan',
    available: false,
    availableDate: 'Sep 2026',
    location: 'Alcázar de San Juan, Castilla-La Mancha',
    github: 'valentina-cruz-smr',
    about: 'Alumna de 1º CFGM Sistemas Microinformáticos y Redes. Autodidacta en ciberseguridad y administración de sistemas. Ha montado su propio home lab y participa en CTFs online. La tecnología no tiene género y ella lo demuestra cada día. Disponible para FCT el próximo curso.',
    skills: [
      { name: 'Redes TCP/IP',          level: 'avanzado' },
      { name: 'Linux sysadmin',         level: 'medio' },
      { name: 'Ciberseguridad / CTF',   level: 'medio' },
      { name: 'Cisco (CCNA básico)',    level: 'medio' },
      { name: 'Docker / contenedores',  level: 'basico' },
      { name: 'Python scripting',        level: 'basico' },
    ],
    projects: [
      { icon: '🛡️', title: 'CTF HackTheBox · Top 10%', desc: 'Participación activa en HackTheBox y TryHackMe. Ranking top 10% de España en su nivel tras 8 meses de práctica', tags: ['CTF', 'Ciberseguridad', 'Linux', 'Hacking ético'] },
      { icon: '🖧',  title: 'Red corporativa con VLANs', desc: 'Diseño y configuración de red empresarial con 4 VLANs, switch Cisco gestionable, router y servidor DNS local', tags: ['VLAN', 'Cisco', 'DNS', 'Routing'] },
    ],
    verifiedBy: { name: 'Prof. R. Pérez', skills: 5 },
    ods: [9, 4, 17],
  },
];
...
const mockStudentsTable = [
  ...
  { initials:'DR', name:'Diego Ramírez Castro',   cycle:'CFGS DAW',               company:'Digital Agency Sur',     status:'firmado',   label:'Conv. Firmado',    weeks:'—' },
  { initials:'EF', name:'Elena Fuentes Ramos',    cycle:'CFGS DAM',               company:'Digital Agency Sur',     status:'firmado',   label:'Conv. Firmado',    weeks:'—' },
  { initials:'CM', name:'Carlos Mendoza Pérez',   cycle:'CFGM CAE',               company:'Residencia La Mancha',   status:'pendiente', label:'Pendiente',        weeks:'—' },
  { initials:'FA', name:'Fátima Al-Rashid',       cycle:'CFGM Inst. Eléctricas',  company:'ElectroCLM Instalaciones',status:'en-curso', label:'En Curso',         weeks:'4/16' },
  { initials:'RA', name:'Rubén Almagro Díaz',     cycle:'CFGS Adm. y Finanzas',   company:'Gestoría Manchega SL',   status:'pendiente', label:'Pendiente',        weeks:'—' },
  { initials:'VC', name:'Valentina Cruz Molina',  cycle:'CFGM SMR',               company:'Pendiente asignación',   status:'pendiente', label:'Pendiente',        weeks:'—' },
];
...
function renderTutorPanel() {
  ...
  if (companiesEl) {
    const cos = [
      ...
      { name: 'IndustrialCLM Robótica',     active: true },
      { name: 'Digital Agency Sur',         active: true },
      { name: 'Residencia La Mancha',       active: true },
      { name: 'ElectroCLM Instalaciones',   active: true },
      { name: 'Gestoría Manchega SL',       active: true },
      { name: 'TechSur Telecomunicaciones', active: false },
    ];
